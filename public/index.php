            ...
            <div class="col-sm">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Episode dans la lignée des précédents. paysages magnifiques. des casses-têtes bien pensés. par contre un peu déçus par les animation qui manquent de réalisme lors des sauts.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Bon jeux , pour les 10 premières heures de jeux rien à dire .. mise à part quelques bug de l’IA qui reste coincé avec des objet sur leur trajet .</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">C'est un trés bon jeu, une réussite, le portage sur PC est tres bien, le défaut les menus pas adapter au pc trop console et pas ergonomique du tout, j'ai pas eu de déco ou de plantage,</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm mt-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Episode dans la lignée des précédents. paysages magnifiques. des casses-têtes bien pensés. par contre un peu déçus par les animation qui manquent de réalisme lors des sauts, et par des beugs sur certaine phase de jeu.</p>
                    </div>
                </div>
            </div>
